...
Edge::Edge(Gradients pGradients, Vertex vStart, Vertex vEnd, int32_t iMinYVertIndex)
{
	...
	m_fColourR 		= 	pGradients.GetColourR(iMinYVertIndex) +
						pGradients.GetColourRXStep() * fXPreStep +
						pGradients.GetColourRYStep() * fYPreStep;
	m_fColourRStep	= 	pGradients.GetColourRYStep() + pGradients.GetColourRXStep() * m_fXStep;

	m_fColourG 		= 	pGradients.GetColourG(iMinYVertIndex) +
						pGradients.GetColourGXStep() * fXPreStep +
						pGradients.GetColourGYStep() * fYPreStep;
	m_fColourGStep	= 	pGradients.GetColourGYStep() + pGradients.GetColourGXStep() * m_fXStep;

	m_fColourB 		= 	pGradients.GetColourB(iMinYVertIndex) +
						pGradients.GetColourBXStep() * fXPreStep +
						pGradients.GetColourBYStep() * fYPreStep;
	m_fColourBStep	= 	pGradients.GetColourBYStep() + pGradients.GetColourBXStep() * m_fXStep;

	m_fColourA 		= 	pGradients.GetColourA(iMinYVertIndex) +
						pGradients.GetColourAXStep() * fXPreStep +
						pGradients.GetColourAYStep() * fYPreStep;
	m_fColourAStep	= 	pGradients.GetColourAYStep() + pGradients.GetColourAXStep() * m_fXStep;
}

int32_t Edge::GetYStart() {		return m_iYStart; }
int32_t Edge::GetYEnd() {		return m_iYEnd; }

float Edge::GetX() {			return m_fX; }
float Edge::GetTexCoordX() {	return m_fTexCoordX; }
float Edge::GetTexCoordY() {	return m_fTexCoordY; }
float Edge::GetOneOverZ() {		return m_fOneOverZ; }
float Edge::GetDepth() {		return m_fDepth; }
float Edge::GetLightAmt() {		return m_fLightAmt; }
float Edge::GetColourR() {		return m_fColourR; }
float Edge::GetColourG() {		return m_fColourG; }
float Edge::GetColourB() {		return m_fColourB; }
float Edge::GetColourA() {		return m_fColourA; }
...
void Edge::Step()
{
	...
	m_fColourR		+= m_fColourRStep;
	m_fColourG		+= m_fColourGStep;
	m_fColourB		+= m_fColourBStep;
	m_fColourA		+= m_fColourAStep;
}