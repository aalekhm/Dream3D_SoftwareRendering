...
{
	return m_Vertices.size() / 3;// m_pMeshObjLoader->getNumFaces();
}

void Mesh::Draw(RenderContext* pGraphics, Matrix4f& matViewProjection, Matrix4f& matTransform, Sprite* pBitmapTexture)
{
	...
	for(int i = 0; i < GetNumFaces(); i++)
	{
		...
		pGraphics->DrawTriangle(	v1->Transform(mvp, matTransform),
