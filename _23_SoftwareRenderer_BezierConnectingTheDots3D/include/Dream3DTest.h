...
class Dream3DTest : EngineManager
{
	...
	protected:
		...
		void							DrawBezierCurveFromPointList(	bool bIs2D, 
		...
		void							GenerateBezierCurvePoints(std::vector<Vector4f>& vInititalList, std::vector<Vector4f>& vFinalList);

		void							DrawStatusBar();

		std::string						m_sStatusBasrString;
	private:
