...
{	
	for (int i = 0; i < m_pMeshObjLoader->getNumFaces(); i++)
	{
		...
		Vertex v1(Vector4f(sV1Pos->x, sV1Pos->y, sV1Pos->z, 1.0f), Vector4f(sV1TexCoord->x, sV1TexCoord->y, 0.0f, 0.0f), Vector4f(sV1Normal->x, sV1Normal->y, sV1Normal->z, 0.0f));
		...
		Vertex v2(Vector4f(sV2Pos->x, sV2Pos->y, sV2Pos->z, 1.0f), Vector4f(sV2TexCoord->x, sV2TexCoord->y, 0.0f, 0.0f), Vector4f(sV2Normal->x, sV2Normal->y, sV2Normal->z, 0.0f));
		...
		Vertex v3(Vector4f(sV3Pos->x, sV3Pos->y, sV3Pos->z, 1.0f), Vector4f(sV3TexCoord->x, sV3TexCoord->y, 0.0f, 0.0f), Vector4f(sV3Normal->x, sV3Normal->y, sV3Normal->z, 0.0f));
