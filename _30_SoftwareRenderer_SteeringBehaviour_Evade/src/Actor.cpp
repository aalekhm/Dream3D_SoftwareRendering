...
unsigned long Actor::GetElapsedTime()
{
	return m_lElapsedTimeMs;
}

ActorBehaviour* Actor::AddBehaviour(ActorBehaviourType eActorBehaviourType)
{
	...
	return (ActorBehaviour*)m_BehaviourMap[eActorBehaviourType].get();
}
